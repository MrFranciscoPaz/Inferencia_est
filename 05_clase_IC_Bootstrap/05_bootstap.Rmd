...
Hata ahora vimos lo que es una estimación plug-in y la idea de bootstrap, pero vale la pena recalcar un par de cosas.
...
```{r}
y_mues <- sample(y, size = 50, replace = FALSE)
```
